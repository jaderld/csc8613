...
def main():
    ...
    # TODO 2: définir la liste des features Feast
    features = [
        # subs_profile_fv
    ...
    with mlflow.start_run(run_name=f"rf_baseline_{AS_OF}") as run:
        ...
        # TODO 9: logger le modèle (pipeline complète)
